...
{
    public class ChaletModel : PageModel
    {
        [BindProperty]
        ...
        public IActionResult OnPost()
        {
            ...
            TempData["Message"] = $"Checking chalet availability for {Booking.Guests} guests from {Booking.CheckInDate} to {Booking.CheckOutDate}";
